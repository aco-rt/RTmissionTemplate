	...
	if(count _num >2) then
		{
			...
			[20,[],{wsquadRP3 SetPos (player modeltoworld [0,3,0]); hint "Rally Point Deployed"},{hint "Deploying interupted"},"Deploying Rally point"] call ace_common_fnc_progressBar
		} 
	else 
		{
