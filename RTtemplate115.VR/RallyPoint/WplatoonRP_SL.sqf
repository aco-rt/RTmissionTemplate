			...
			if(count _num >2) then
				{
					...
					[80,[],{RP_west SetPos (player modeltoworld [0,3,0]); hint "Rally Point Deployed"},{hint "Deploying interrupted"},"Deploying Rally point"] call ace_common_fnc_progressBar
				}
			else
				{
